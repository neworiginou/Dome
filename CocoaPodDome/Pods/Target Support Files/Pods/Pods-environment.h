...
// LoopingVideoView
#define COCOAPODS_POD_AVAILABLE_LoopingVideoView
#define COCOAPODS_VERSION_MAJOR_LoopingVideoView 1
#define COCOAPODS_VERSION_MINOR_LoopingVideoView 0
#define COCOAPODS_VERSION_PATCH_LoopingVideoView 0
